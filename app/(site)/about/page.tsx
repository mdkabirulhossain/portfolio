...
// import { Sparkles, Code2, Briefcase, GraduationCap, Target } from "lucide-react";
...
//           } backdrop-blur-sm rounded-2xl border p-8 md:p-12 mb-16`}
//         >
...
//               transition={{ duration: 0.6 }}
//               className="text-3xl font-bold mb-8 bg-clip-text text-transparent bg-linear-to-r from-cyan-400 to-blue-500"
//             >
//               Technical Skills
//             </motion.h2>
...
//                     className={`w-28 ${
//                       theme !== "light" ? "text-gray-300" : "text-gray-700"
//                     } font-medium group-hover:text-cyan-400 transition-colors`}
//                   >
//                     {skill.name}
//                   </div>
...
//                     className="w-3 h-3 rounded-full bg-cyan-400 shadow-cyan-400/50 shadow-lg group-hover:scale-125 transition-transform"
//                   />

//                   {/* Skill Button with Gradient */}
//                   <motion.div
//                     whileHover={{ scale: 1.05 }}
//                     className="cursor-pointer text-white font-semibold px-4 py-2 rounded-full text-base shadow-lg shadow-purple-500/30 transition-all bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-indigo-600 hover:to-pink-600 flex items-center gap-2"
//                   >
...
//               animate={{ opacity: 1, x: 0 }}
//               transition={{ duration: 0.6 }}
//               className="text-3xl font-bold mb-8 bg-clip-text text-transparent bg-linear-to-r from-purple-400 to-pink-500"
//             >
//               Skills Analytics
//             </motion.h2>
...
//                 className={`${
//                   theme !== "light"
//                     ? "bg-gradient-to-br from-gray-900/50 to-gray-800/50 border-gray-700/40"
//                     : "bg-gradient-to-br from-gray-100 to-gray-200 border-gray-300"
//                 } p-6 rounded-2xl backdrop-blur border`}
//               >
...
//                     <XAxis
//                       dataKey="name"
//                       tick={{ fill: theme !== "light" ? "#9ca3af" : "#6b7280", fontSize: 11 }}
...
//                         border: `1px solid ${theme !== "light" ? "#374151" : "#d1d5db"}`,
